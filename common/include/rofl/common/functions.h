 ...
 */
#ifndef ROFL_COMMON_FUNCTIONS_H_
#define ROFL_COMMON_FUNCTIONS_H_
...
namespace rofl {
    ...
    /**
     * Returns the next interger to the given float using fast computation method.
     */
    ...
    /**
     * Computes atan2() using fastAtanf(). It uses clever interval as suggested by:
